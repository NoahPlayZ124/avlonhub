...
--[[ Script ]]--
local scriptcopy = script:Clone()
scriptcopy.Parent = imgui
...
local Prefabs = scriptcopy.Parent:WaitForChild("Prefabs")
local Windows = scriptcopy.Parent:FindFirstChild("Windows")
...
UIS.InputBegan:Connect(function(input, gameProcessed)
    if input.KeyCode == ((typeof(ui_options.toggle_key) == "EnumItem") and ui_options.toggle_key or Enum.KeyCode.RightShift) then
        if scriptcopy.Parent then
            if not checks.binding then
                scriptcopy.Parent.Enabled = not scriptcopy.Parent.Enabled
            end
        end
    end
end)
                ...
                do -- Tab Elements
                    ...
                    function tab_data:AddKeybind(keybind_name, callback, keybind_options)
                        ...
                        function keybind_data:SetKeybind(Keybind)
                            if Keybind == nil then Keybind = Enum.UserInputType.MouseButton2 end
                        ...
                        input.MouseButton1Click:Connect(function()
                            ...
                            elseif a.UserInputType == Enum.UserInputType.MouseButton1 or a.UserInputType == Enum.UserInputType.MouseButton2 then
