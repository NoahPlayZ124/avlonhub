if Drawing then
	...
	local Mods_NoFallDamage = false
	
	local Mods_FireRate = 850
	...
	Network.send = function(self, ...)
		local Args = {...}
		if Args[1] == "changehealthx" and Mods_NoFallDamage then
			return;
		end
	...
	local Mods2_NoSwayToggle = Mods2_Window:AddSwitch("No Sway", function(bool)
		...
		--Inf Penetration
	local Mods2_NoSwayToggle = Mods2_Window:AddSwitch("Infinite Penetration", function(bool)
		if bool then
			for i,v in pairs(game.ReplicatedStorage.GunModules:GetChildren()) do
				local mod = require(v) 
				--Inf Penetration
		...
		--Inf Ammo
	local Mods2_NoSwayToggle = Mods2_Window:AddSwitch("Infinite Ammo", function(bool)
		if bool then
			for i,v in pairs(game.ReplicatedStorage.GunModules:GetChildren()) do
				local mod = require(v) 
				--Inf Ammo
