if Drawing and getgc and writefile and readfile then
   ...
   --         getbodyparts = v.getbodyparts;
	...
	local ESP_GrenadeESPToggle = ESP_Window:AddSwitch("Grenade ESP", function(bool)
		Main_Settings.visuals.grenadeesp = bool
	end)
	ESP_GrenadeESPToggle:Set(Main_Settings.visuals.grenadeesp)
	...
	Mods_FastEquipToggle:Set(Main_Settings.mods1.fastequip)
		...
		--Grenade TP
	local Mods_GrenadeTPToggle = Mods_Window:AddSwitch("Grenade TP", function(bool)
