if Drawing and getgc and writefile and readfile then
    ...
    CrossLine1.Transparency = tonumber(math.acos(visuals_transparency) - 0.50)
	...
	CrossLine2.Transparency = tonumber(math.acos(visuals_transparency) - 0.50)
	
	local FOVCircle = Drawing.new("Circle")
	FOVCircle.Transparency = tonumber(math.acos(visuals_transparency) - 0.50)
	...
	Mods_Window:AddLabel("Respawn for them to take effect!")

		--NoRecoil
	local Mods_NoRecoilToggle = Mods_Window:AddSwitch("No Recoil", function(bool)
	...
	Mods_NoRecoilToggle:Set(Main_Settings.mods1.norecoil)
	...
	Mods_InstantReloadToggle:Set(Main_Settings.mods1.instantreload)
	
		--No Reload
	local Mods_NoReloadToggle = Mods_Window:AddSwitch("No Reload", function(bool)
	...
	Mods_NoReloadToggle:Set(Main_Settings.mods1.noreload)
	
		--NoFallDamage
	local Mods_NoFallDamageToggle = Mods_Window:AddSwitch("No Fall Damage", function(bool)
		Main_Settings.mods1.nofalldamage = bool
	end)
	Mods_NoFallDamageToggle:Set(Main_Settings.mods1.nofalldamage)
	
		--NoSpread
	local Mods_NoSpreadToggle = Mods_Window:AddSwitch("No Spread", function(bool)
	...
	Mods_NoSpreadToggle:Set(Main_Settings.mods1.nospread)
	
		--Rapid Fire
	local Mods_RapidFireToggle = Mods_Window:AddSwitch("Fast Bullets", function(bool)
	...
	Mods_RapidFireToggle:Set(Main_Settings.mods1.rapidfire)

		--Instant Knife
	local Mods_InstantKnifeToggle = Mods_Window:AddSwitch("Instant Knife", function(bool)
	...
	Mods_InstantKnifeToggle:Set(Main_Settings.mods1.instantknife)

		--Fast Equip
	local Mods_FastEquipToggle = Mods_Window:AddSwitch("Fast Equip", function(bool)
	...
	Mods_FireRateSlider:Set(Main_Settings.mods1.firerate)
	
	fireratefix = true
	
		--Rainbow Gun
	local Mods_RainbowGun = Mods_Window:AddButton("Rainbow Gun", function(bool)
		game:GetService("RunService").Stepped:Connect(function()
	...
	Network.send = function(self, ...)
		local Args = {...}
		if Args[1] == "changehealthx" and Main_Settings.mods1.nofalldamage then
			return;
		end
	...
	local Mods2_Window = Window:AddTab("Mods 2")
	
	Mods2_Window:AddLabel("Respawn for them to take effect!")

		--All Auto
	local Mods2_AllAutoToggle = Mods2_Window:AddSwitch("All Auto", function(bool)
	...
	Mods2_AllAutoToggle:Set(Main_Settings.mods2.allauto)
	
		--Hide From Radar
	local Mods2_hidefromradarToggle = Mods2_Window:AddSwitch("Hide From Radar", function(bool)
	...
	Mods2_hidefromradarToggle:Set(Main_Settings.mods2.hidefromradar)
	
		--No Sway
	local Mods2_NoSwayToggle = Mods2_Window:AddSwitch("No Sway", function(bool)
	...
	Mods2_NoSwayToggle:Set(Main_Settings.mods2.nosway)
	...
	local walkspeedfix = false
		--Speed
	local Other_SpeedSlider = Other_Window:AddSlider("Walk Speed", function(x)
	    if walkspeedfix == true then
    		Other_Speed = x
    		if x ~= Main_Settings.other.walkspeed then
	...
	Other_SpeedSlider:Set(Main_Settings.other.walkspeed)
	
	walkspeedfix = true
	
	local jumppowerfix = false
		--JumpPower
	local Other_JumpSlider = Other_Window:AddSlider("Jump Power", function(x)
	    if jumppowerfix == true then
    		Other_Jump = x * 2
    		if x ~= Main_Settings.other.jumppower then
	...
	Other_JumpSlider:Set(Main_Settings.other.jumppower)
	...
	Other_FullBrightToggle:Set(Main_Settings.other.fullbright)
...
b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_f[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_h[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2]avlon_c[avlon_e](avlon_g(avlon_c,avlon_e+1,avlon_a[3]))avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];do return end;end;elseif avlon_e<=214 then if avlon_e<=212 then avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]]-avlon_a[4];elseif avlon_e>213 then local avlon_e;local avlon_h;local avlon_l,avlon_m;local avlon_k;local avlon_e;avlon_c[avlon_a[2]]=avlon_f[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2];avlon_k=avlon_c[avlon_a[3]];avlon_c[avlon_e+1]=avlon_k;avlon_c[avlon_e]=avlon_k[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2]avlon_c[avlon_e]=avlon_c[avlon_e](avlon_g(avlon_c,avlon_e+1,avlon_a[3]))avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2];avlon_k=avlon_c[avlon_a[3]];avlon_c[avlon_e+1]=avlon_k;avlon_c[avlon_e]=avlon_k[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2]avlon_l,avlon_m=avlon_j(avlon_c[avlon_e](avlon_c[avlon_e+1]))avlon_i=avlon_m+avlon_e-1 avlon_h=0;for avlon_a=avlon_e,avlon_i do avlon_h=avlon_h+1;avlon_c[avlon_a]=avlon_l[avlon_h];end;avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2]avlon_l={avlon_c[avlon_e](avlon_g(avlon_c,avlon_e+1,avlon_i))};avlon_h=0;for avlon_a=avlon_e,avlon_a[4]do avlon_h=avlon_h+1;avlon_c[avlon_a]=avlon_l[avlon_h];end avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_b=avlon_a[3];else local avlon_f;local avlon_e;avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]]*avlon_a[4];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]]+avlon_c[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]][avlon_a[3]]=avlon_c[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2];avlon_f=avlon_c[avlon_a[3]];avlon_c[avlon_e+1]=avlon_f;avlon_c[avlon_e]=avlon_f[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2]avlon_c[avlon_e]=avlon_c[avlon_e](avlon_g(avlon_c,avlon_e+1,avlon_a[3]))avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2];avlon_f=avlon_c[avlon_a[3]];avlon_c[avlon_e+1]=avlon_f;avlon_c[avlon_e]=avlon_f[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2]avlon_c[avlon_e]=avlon_c[avlon_e](avlon_g(avlon_c,avlon_e+1,avlon_a[3]))avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2];avlon_f=avlon_c[avlon_a[3]];avlon_c[avlon_e+1]=avlon_f;avlon_c[avlon_e]=avlon_f[avlon_a[4]];end;elseif avlon_e<=215 then avlon_c[avlon_a[2]]=avlon_h[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]][avlon_a[3]]=avlon_a[4];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=(avlon_a[3]~=0);avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_h[avlon_a[3]]=avlon_c[avlon_a[2]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];do return end;elseif avlon_e>216 then if(avlon_c[avlon_a[2]]==avlon_c[avlon_a[4]])then avlon_b=avlon_b+1;else avlon_b=avlon_a[3];end;else local avlon_b=avlon_a[2]local avlon_d,avlon_a=avlon_j(avlon_c[avlon_b](avlon_g(avlon_c,avlon_b+1,avlon_a[3])))avlon_i=avlon_a+avlon_b-1 local avlon_a=0;for avlon_b=avlon_b,avlon_i do avlon_a=avlon_a+1;avlon_c[avlon_b]=avlon_d[avlon_a];end;end;elseif avlon_e<=229 then if avlon_e<=223 then if avlon_e<=220 then if avlon_e<=218 then local avlon_d=avlon_c[avlon_a[4]];if not avlon_d then avlon_b=avlon_b+1;else avlon_c[avlon_a[2]]=avlon_d;avlon_b=avlon_a[3];end;elseif avlon_e>219 then local avlon_f;local avlon_e;avlon_c[avlon_a[2]]=avlon_h[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_h[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_c[avlon_a[4]]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2];avlon_f=avlon_c[avlon_a[3]];avlon_c[avlon_e+1]=avlon_f;avlon_c[avlon_e]=avlon_f[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2]avlon_c[avlon_e](avlon_c[avlon_e+1])avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];do return end;else local avlon_e;avlon_c[avlon_a[2]][avlon_a[3]]=avlon_a[4];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_f[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2]avlon_c[avlon_e]=avlon_c[avlon_e](avlon_g(avlon_c,avlon_e+1,avlon_a[3]))avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]][avlon_a[3]]=avlon_c[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]][avlon_a[3]]=avlon_a[4];end;elseif avlon_e<=221 then for avlon_a=avlon_a[2],avlon_a[3]do avlon_c[avlon_a]=nil;end;elseif avlon_e==222 then local avlon_e;avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2]avlon_c[avlon_e]=avlon_c[avlon_e](avlon_g(avlon_c,avlon_e+1,avlon_a[3]))avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]][avlon_a[3]]=avlon_c[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]][avlon_a[3]]=avlon_a[4];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_f[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];else avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_f[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];if(avlon_c[avlon_a[2]]==avlon_c[avlon_a[4]])then avlon_b=avlon_b+1;else avlon_b=avlon_a[3];end;end;elseif avlon_e<=226 then if avlon_e<=224 then local avlon_a=avlon_a[2]local avlon_d,avlon_b=avlon_j(avlon_c[avlon_a](avlon_g(avlon_c,avlon_a+1,avlon_i)))avlon_i=avlon_b+avlon_a-1 local avlon_b=0;for avlon_a=avlon_a,avlon_i do avlon_b=avlon_b+1;avlon_c[avlon_a]=avlon_d[avlon_b];end;elseif avlon_e>225 then local avlon_e;avlon_c[avlon_a[2]][avlon_a[3]]=avlon_a[4];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]][avlon_a[3]]=avlon_a[4];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]][avlon_a[3]]=avlon_a[4];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_f[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2]avlon_c[avlon_e]=avlon_c[avlon_e](avlon_g(avlon_c,avlon_e+1,avlon_a[3]))avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]]*avlon_c[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]][avlon_a[3]]=avlon_c[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_f[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2]avlon_c[avlon_e]=avlon_c[avlon_e](avlon_g(avlon_c,avlon_e+1,avlon_a[3]))avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]][avlon_a[3]]=avlon_c[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_f[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2]avlon_c[avlon_e]=avlon_c[avlon_e](avlon_c[avlon_e+1])avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]][avlon_a[3]]=avlon_c[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]][avlon_a[3]]=avlon_a[4];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_f[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]][avlon_a[3]]=avlon_c[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]][avlon_a[3]]=avlon_c[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]][avlon_a[3]]=avlon_c[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]][avlon_a[3]]=avlon_c[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]][avlon_a[3]]=avlon_c[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]][avlon_a[3]]=avlon_c[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_h[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_h[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=#avlon_c[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]]+avlon_a[4];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]][avlon_c[avlon_a[3]]]=avlon_c[avlon_a[4]];else local avlon_e;avlon_c[avlon_a[2]]={};avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_f[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2]avlon_c[avlon_e]=avlon_c[avlon_e](avlon_c[avlon_e+1])avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];if(avlon_c[avlon_a[2]]==avlon_a[4])then avlon_b=avlon_b+1;else avlon_b=avlon_a[3];end;end;elseif avlon_e<=227 then avlon_c[avlon_a[2]]={};elseif avlon_e==228 then avlon_f[avlon_a[3]]=avlon_c[avlon_a[2]];else if(avlon_a[2]<avlon_c[avlon_a[4]])then avlon_b=avlon_b+1;else avlon_b=avlon_a[3];end;end;elseif avlon_e<=235 then if avlon_e<=232 then if avlon_e<=230 then local avlon_a=avlon_a[2]avlon_c[avlon_a]=avlon_c[avlon_a](avlon_c[avlon_a+1])elseif avlon_e>231 then local avlon_f;local avlon_e;avlon_e=avlon_a[2]avlon_c[avlon_e](avlon_g(avlon_c,avlon_e+1,avlon_a[3]))avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_c[avlon_a[4]]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2];avlon_f=avlon_c[avlon_a[3]];avlon_c[avlon_e+1]=avlon_f;avlon_c[avlon_e]=avlon_f[avlon_c[avlon_a[4]]];else local avlon_b=avlon_a[2]local avlon_d={avlon_c[avlon_b]()};local avlon_e=avlon_a[4];local avlon_a=0;for avlon_b=avlon_b,avlon_e do avlon_a=avlon_a+1;avlon_c[avlon_b]=avlon_d[avlon_a];end end;elseif avlon_e<=233 then local avlon_i;local avlon_e;avlon_e=avlon_a[2];avlon_i=avlon_c[avlon_a[3]];avlon_c[avlon_e+1]=avlon_i;avlon_c[avlon_e]=avlon_i[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2]avlon_c[avlon_e]=avlon_c[avlon_e](avlon_g(avlon_c,avlon_e+1,avlon_a[3]))avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2];avlon_i=avlon_c[avlon_a[3]];avlon_c[avlon_e+1]=avlon_i;avlon_c[avlon_e]=avlon_i[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2]avlon_c[avlon_e]=avlon_c[avlon_e](avlon_c[avlon_e+1])avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_h[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]][avlon_a[3]]=avlon_c[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]][avlon_a[3]]=avlon_c[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_f[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_h[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2]avlon_c[avlon_e]=avlon_c[avlon_e](avlon_c[avlon_e+1])avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2]avlon_c[avlon_e]=avlon_c[avlon_e](avlon_g(avlon_c,avlon_e+1,avlon_a[3]))avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]][avlon_a[3]]=avlon_c[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_h[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]]*avlon_a[4];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]]+avlon_c[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]][avlon_a[3]]=avlon_c[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2];avlon_i=avlon_c[avlon_a[3]];avlon_c[avlon_e+1]=avlon_i;avlon_c[avlon_e]=avlon_i[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2]avlon_c[avlon_e]=avlon_c[avlon_e](avlon_c[avlon_e+1])avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2];avlon_i=avlon_c[avlon_a[3]];avlon_c[avlon_e+1]=avlon_i;avlon_c[avlon_e]=avlon_i[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2]avlon_c[avlon_e]=avlon_c[avlon_e](avlon_c[avlon_e+1])avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_h[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]]*avlon_a[4];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]]+avlon_c[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]][avlon_a[3]]=avlon_c[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_f[avlon_a[3]];elseif avlon_e==234 then avlon_c[avlon_a[2]]=avlon_h[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_h[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]][avlon_a[3]]=avlon_c[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_h[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_h[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]][avlon_a[3]]=avlon_c[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_h[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];else local avlon_e;local avlon_h;local avlon_l,avlon_m;local avlon_k;local avlon_e;avlon_c[avlon_a[2]]=avlon_f[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2];avlon_k=avlon_c[avlon_a[3]];avlon_c[avlon_e+1]=avlon_k;avlon_c[avlon_e]=avlon_k[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2]avlon_c[avlon_e]=avlon_c[avlon_e](avlon_g(avlon_c,avlon_e+1,avlon_a[3]))avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2];avlon_k=avlon_c[avlon_a[3]];avlon_c[avlon_e+1]=avlon_k;avlon_c[avlon_e]=avlon_k[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2]avlon_l,avlon_m=avlon_j(avlon_c[avlon_e](avlon_c[avlon_e+1]))avlon_i=avlon_m+avlon_e-1 avlon_h=0;for avlon_a=avlon_e,avlon_i do avlon_h=avlon_h+1;avlon_c[avlon_a]=avlon_l[avlon_h];end;avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2]avlon_l={avlon_c[avlon_e](avlon_g(avlon_c,avlon_e+1,avlon_i))};avlon_h=0;for avlon_a=avlon_e,avlon_a[4]do avlon_h=avlon_h+1;avlon_c[avlon_a]=avlon_l[avlon_h];end avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_b=avlon_a[3];end;elseif avlon_e<=238 then if avlon_e<=236 then local avlon_e;avlon_e=avlon_a[2]avlon_c[avlon_e]=avlon_c[avlon_e](avlon_g(avlon_c,avlon_e+1,avlon_a[3]))avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]][avlon_a[3]]=avlon_c[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_f[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]][avlon_a[3]]=avlon_c[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_f[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2]avlon_c[avlon_e]=avlon_c[avlon_e](avlon_g(avlon_c,avlon_e+1,avlon_a[3]))avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]][avlon_a[3]]=avlon_c[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]][avlon_a[3]]=avlon_a[4];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]][avlon_a[3]]=avlon_c[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_f[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2]avlon_c[avlon_e]=avlon_c[avlon_e](avlon_g(avlon_c,avlon_e+1,avlon_a[3]))avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]][avlon_a[3]]=avlon_c[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]][avlon_a[3]]=avlon_a[4];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_f[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2]avlon_c[avlon_e]=avlon_c[avlon_e](avlon_g(avlon_c,avlon_e+1,avlon_a[3]))avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]][avlon_a[3]]=avlon_c[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_f[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2]avlon_c[avlon_e]=avlon_c[avlon_e](avlon_g(avlon_c,avlon_e+1,avlon_a[3]))avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]][avlon_a[3]]=avlon_c[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]][avlon_a[3]]=avlon_a[4];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_f[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]][avlon_a[3]]=avlon_c[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]][avlon_a[3]]=avlon_a[4];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_f[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2]avlon_c[avlon_e]=avlon_c[avlon_e](avlon_g(avlon_c,avlon_e+1,avlon_a[3]))avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]][avlon_a[3]]=avlon_c[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]][avlon_a[3]]=avlon_a[4];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]][avlon_a[3]]=avlon_a[4];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]][avlon_a[3]]=avlon_c[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_f[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2]avlon_c[avlon_e]=avlon_c[avlon_e](avlon_g(avlon_c,avlon_e+1,avlon_a[3]))avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]][avlon_a[3]]=avlon_c[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]][avlon_a[3]]=avlon_a[4];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_f[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2]avlon_c[avlon_e]=avlon_c[avlon_e](avlon_g(avlon_c,avlon_e+1,avlon_a[3]))avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]][avlon_a[3]]=avlon_c[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]][avlon_a[3]]=avlon_a[4];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_f[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2]avlon_c[avlon_e]=avlon_c[avlon_e](avlon_g(avlon_c,avlon_e+1,avlon_a[3]))avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]][avlon_a[3]]=avlon_c[avlon_a[4]];elseif avlon_e>237 then local avlon_e;local avlon_h;local avlon_k,avlon_m;local avlon_l;local avlon_e;avlon_c[avlon_a[2]]=avlon_f[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2];avlon_l=avlon_c[avlon_a[3]];avlon_c[avlon_e+1]=avlon_l;avlon_c[avlon_e]=avlon_l[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2]avlon_k,avlon_m=avlon_j(avlon_c[avlon_e](avlon_c[avlon_e+1]))avlon_i=avlon_m+avlon_e-1 avlon_h=0;for avlon_a=avlon_e,avlon_i do avlon_h=avlon_h+1;avlon_c[avlon_a]=avlon_k[avlon_h];end;avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2]avlon_k={avlon_c[avlon_e](avlon_g(avlon_c,avlon_e+1,avlon_i))};avlon_h=0;for avlon_a=avlon_e,avlon_a[4]do avlon_h=avlon_h+1;avlon_c[avlon_a]=avlon_k[avlon_h];end avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_b=avlon_a[3];else local avlon_f=avlon_a[2];local avlon_d={};for avlon_a=1,#avlon_k do local avlon_a=avlon_k[avlon_a];for avlon_b=0,#avlon_a do local avlon_a=avlon_a[avlon_b];local avlon_e=avlon_a[1];local avlon_b=avlon_a[2];if avlon_e==avlon_c and avlon_b>=avlon_f then avlon_d[avlon_b]=avlon_e[avlon_b];avlon_a[1]=avlon_d;end;end;end;end;elseif avlon_e<=239 then local avlon_f;local avlon_e;avlon_e=avlon_a[2]avlon_c[avlon_e](avlon_g(avlon_c,avlon_e+1,avlon_a[3]))avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=(avlon_a[3]~=0);avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_h[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2];avlon_f=avlon_c[avlon_a[3]];avlon_c[avlon_e+1]=avlon_f;avlon_c[avlon_e]=avlon_f[avlon_a[4]];elseif avlon_e>240 then local avlon_e;local avlon_g;avlon_f[avlon_a[3]]=avlon_c[avlon_a[2]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_c[avlon_a[4]]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_g=avlon_a[2];avlon_e=avlon_c[avlon_a[3]];avlon_c[avlon_g+1]=avlon_e;avlon_c[avlon_g]=avlon_e[avlon_c[avlon_a[4]]];else avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]]+avlon_a[4];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];do return avlon_c[avlon_a[2]]end avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];do return end;end;elseif avlon_e<=265 then if avlon_e<=253 then if avlon_e<=247 then if avlon_e<=244 then if avlon_e<=242 then if(avlon_a[2]<avlon_c[avlon_a[4]])then avlon_b=avlon_a[3];else avlon_b=avlon_b+1;end;elseif avlon_e>243 then avlon_c[avlon_a[2]]=avlon_a[3];else avlon_c[avlon_a[2]]();end;elseif avlon_e<=245 then local avlon_e;avlon_c[avlon_a[2]]=avlon_h[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]={};avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_f[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_h[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2]avlon_c[avlon_e]=avlon_c[avlon_e](avlon_g(avlon_c,avlon_e+1,avlon_a[3]))avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]][avlon_a[3]]=avlon_c[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_h[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2]avlon_c[avlon_e](avlon_g(avlon_c,avlon_e+1,avlon_a[3]))avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_b=avlon_a[3];elseif avlon_e>246 then local avlon_f;local avlon_e;avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2];avlon_f=avlon_c[avlon_a[3]];avlon_c[avlon_e+1]=avlon_f;avlon_c[avlon_e]=avlon_f[avlon_c[avlon_a[4]]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2]avlon_c[avlon_e](avlon_g(avlon_c,avlon_e+1,avlon_a[3]))else local avlon_e;avlon_c[avlon_a[2]][avlon_a[3]]=avlon_c[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_f[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2]avlon_c[avlon_e]=avlon_c[avlon_e](avlon_g(avlon_c,avlon_e+1,avlon_a[3]))avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]][avlon_a[3]]=avlon_c[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]][avlon_a[3]]=avlon_a[4];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_f[avlon_a[3]];end;elseif avlon_e<=250 then if avlon_e<=248 then avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_c[avlon_a[4]]];elseif avlon_e>249 then avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_f[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=(not avlon_c[avlon_a[3]]);avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]][avlon_a[3]]=avlon_c[avlon_a[4]];else avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]]*avlon_a[4];end;elseif avlon_e<=251 then local avlon_d=avlon_a[2];local avlon_b=avlon_c[avlon_a[3]];avlon_c[avlon_d+1]=avlon_b;avlon_c[avlon_d]=avlon_b[avlon_a[4]];elseif avlon_e==252 then local avlon_d=avlon_a[3];local avlon_b=avlon_c[avlon_d]for avlon_a=avlon_d+1,avlon_a[4]do avlon_b=avlon_b..avlon_c[avlon_a];end;avlon_c[avlon_a[2]]=avlon_b;else local avlon_e;avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]][avlon_a[3]]=avlon_c[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]][avlon_a[3]]=avlon_a[4];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_f[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2]avlon_c[avlon_e]=avlon_c[avlon_e](avlon_g(avlon_c,avlon_e+1,avlon_a[3]))avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]][avlon_a[3]]=avlon_c[avlon_a[4]];end;elseif avlon_e<=259 then if avlon_e<=256 then if avlon_e<=254 then local avlon_e;avlon_e=avlon_a[2]avlon_c[avlon_e]=avlon_c[avlon_e](avlon_g(avlon_c,avlon_e+1,avlon_a[3]))avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]][avlon_a[3]]=avlon_c[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]][avlon_a[3]]=avlon_a[4];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]][avlon_a[3]]=avlon_a[4];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_f[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];elseif avlon_e>255 then local avlon_f;local avlon_e;avlon_e=avlon_a[2]avlon_c[avlon_e]=avlon_c[avlon_e](avlon_c[avlon_e+1])avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2];avlon_f=avlon_c[avlon_a[3]];avlon_c[avlon_e+1]=avlon_f;avlon_c[avlon_e]=avlon_f[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2]avlon_c[avlon_e]=avlon_c[avlon_e](avlon_g(avlon_c,avlon_e+1,avlon_a[3]))avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];if not avlon_c[avlon_a[2]]then avlon_b=avlon_b+1;else avlon_b=avlon_a[3];end;else local avlon_e;avlon_e=avlon_a[2]avlon_c[avlon_e]=avlon_c[avlon_e](avlon_c[avlon_e+1])avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_f[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2]avlon_c[avlon_e]=avlon_c[avlon_e](avlon_c[avlon_e+1])avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_f[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2]avlon_c[avlon_e]=avlon_c[avlon_e](avlon_c[avlon_e+1])avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_f[avlon_a[3]];end;elseif avlon_e<=257 then avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]]/avlon_c[avlon_a[4]];elseif avlon_e==258 then local avlon_a=avlon_a[2];do return avlon_g(avlon_c,avlon_a,avlon_i)end;else avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_h[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];if(avlon_c[avlon_a[2]]<avlon_c[avlon_a[4]])then avlon_b=avlon_b+1;else avlon_b=avlon_a[3];end;end;elseif avlon_e<=262 then if avlon_e<=260 then local avlon_e;avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_h[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]][avlon_a[3]]=avlon_c[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2];do return avlon_c[avlon_e],avlon_c[avlon_e+1]end avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_b=avlon_a[3];elseif avlon_e>261 then local avlon_j;local avlon_e;avlon_c[avlon_a[2]]=avlon_f[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_h[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2];avlon_j=avlon_c[avlon_a[3]];avlon_c[avlon_e+1]=avlon_j;avlon_c[avlon_e]=avlon_j[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2]avlon_c[avlon_e]=avlon_c[avlon_e](avlon_c[avlon_e+1])avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]]+avlon_a[4];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_h[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2];avlon_j=avlon_c[avlon_a[3]];avlon_c[avlon_e+1]=avlon_j;avlon_c[avlon_e]=avlon_j[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2]avlon_c[avlon_e]=avlon_c[avlon_e](avlon_c[avlon_e+1])avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]]-avlon_a[4];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2];do return avlon_c[avlon_e](avlon_g(avlon_c,avlon_e+1,avlon_a[3]))end;avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2];do return avlon_g(avlon_c,avlon_e,avlon_i)end;avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];do return end;else avlon_h[avlon_a[3]]=avlon_c[avlon_a[2]];end;elseif avlon_e<=263 then local avlon_e;local avlon_f;local avlon_k,avlon_l;local avlon_h;local avlon_e;avlon_e=avlon_a[2];avlon_h=avlon_c[avlon_a[3]];avlon_c[avlon_e+1]=avlon_h;avlon_c[avlon_e]=avlon_h[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2]avlon_c[avlon_e]=avlon_c[avlon_e](avlon_c[avlon_e+1])avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2];avlon_h=avlon_c[avlon_a[3]];avlon_c[avlon_e+1]=avlon_h;avlon_c[avlon_e]=avlon_h[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2]avlon_k,avlon_l=avlon_j(avlon_c[avlon_e](avlon_c[avlon_e+1]))avlon_i=avlon_l+avlon_e-1 avlon_f=0;for avlon_a=avlon_e,avlon_i do avlon_f=avlon_f+1;avlon_c[avlon_a]=avlon_k[avlon_f];end;avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2]avlon_k={avlon_c[avlon_e](avlon_g(avlon_c,avlon_e+1,avlon_i))};avlon_f=0;for avlon_a=avlon_e,avlon_a[4]do avlon_f=avlon_f+1;avlon_c[avlon_a]=avlon_k[avlon_f];end avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_b=avlon_a[3];elseif avlon_e==264 then local avlon_f;local avlon_e;avlon_c[avlon_a[2]]=avlon_h[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]]+avlon_a[4];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_h[avlon_a[3]]=avlon_c[avlon_a[2]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_h[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2];avlon_f=avlon_c[avlon_a[3]];avlon_c[avlon_e+1]=avlon_f;avlon_c[avlon_e]=avlon_f[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_h[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_h[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]]+avlon_a[4];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2]avlon_c[avlon_e]=avlon_c[avlon_e](avlon_g(avlon_c,avlon_e+1,avlon_a[3]))avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];if(avlon_c[avlon_a[2]]==avlon_a[4])then avlon_b=avlon_b+1;else avlon_b=avlon_a[3];end;else local avlon_b=avlon_a[2];local avlon_d=avlon_c[avlon_a[3]];avlon_c[avlon_b+1]=avlon_d;avlon_c[avlon_b]=avlon_d[avlon_c[avlon_a[4]]];end;elseif avlon_e<=277 then if avlon_e<=271 then if avlon_e<=268 then if avlon_e<=266 then local avlon_f;local avlon_e;avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_h[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2];avlon_f=avlon_c[avlon_a[3]];avlon_c[avlon_e+1]=avlon_f;avlon_c[avlon_e]=avlon_f[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2]avlon_c[avlon_e]=avlon_c[avlon_e](avlon_g(avlon_c,avlon_e+1,avlon_a[3]))avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2];avlon_f=avlon_c[avlon_a[3]];avlon_c[avlon_e+1]=avlon_f;avlon_c[avlon_e]=avlon_f[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2]avlon_c[avlon_e]=avlon_c[avlon_e](avlon_c[avlon_e+1])avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_h[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]][avlon_a[3]]=avlon_c[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];elseif avlon_e==267 then local avlon_e;avlon_c[avlon_a[2]]=avlon_f[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2]avlon_c[avlon_e]=avlon_c[avlon_e](avlon_g(avlon_c,avlon_e+1,avlon_a[3]))avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]][avlon_a[3]]=avlon_c[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_f[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];else local avlon_b=avlon_a[2];local avlon_d=avlon_c[avlon_b];for avlon_a=avlon_b+1,avlon_a[3]do avlon_l(avlon_d,avlon_c[avlon_a])end;end;elseif avlon_e<=269 then if avlon_c[avlon_a[2]]then avlon_b=avlon_b+1;else avlon_b=avlon_a[3];end;elseif avlon_e==270 then do return end;else avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_c[avlon_a[4]]];end;elseif avlon_e<=274 then if avlon_e<=272 then for avlon_a=avlon_a[2],avlon_a[3]do avlon_c[avlon_a]=nil;end;elseif avlon_e>273 then local avlon_e;avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2]avlon_c[avlon_e]=avlon_c[avlon_e](avlon_g(avlon_c,avlon_e+1,avlon_a[3]))avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]][avlon_a[3]]=avlon_c[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]][avlon_a[3]]=avlon_a[4];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]][avlon_a[3]]=avlon_a[4];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_f[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];else avlon_c[avlon_a[2]][avlon_a[3]]=avlon_c[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_h[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]][avlon_a[3]]=avlon_c[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_h[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]][avlon_a[3]]=avlon_c[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_h[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]][avlon_a[3]]=avlon_c[avlon_a[4]];end;elseif avlon_e<=275 then local avlon_e;avlon_c[avlon_a[2]]=avlon_h[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_f[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_h[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2]avlon_c[avlon_e]=avlon_c[avlon_e](avlon_c[avlon_e+1])avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_c[avlon_a[4]]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];do return avlon_c[avlon_a[2]]end avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];do return end;elseif avlon_e==276 then local avlon_i;local avlon_f;local avlon_e;avlon_e=avlon_a[2]avlon_c[avlon_e](avlon_g(avlon_c,avlon_e+1,avlon_a[3]))avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_h[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]][avlon_a[3]]=avlon_a[4];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2];avlon_f=avlon_c[avlon_e]avlon_i=avlon_c[avlon_e+2];if(avlon_i>0)then if(avlon_f>avlon_c[avlon_e+1])then avlon_b=avlon_a[3];else avlon_c[avlon_e+3]=avlon_f;end elseif(avlon_f<avlon_c[avlon_e+1])then avlon_b=avlon_a[3];else avlon_c[avlon_e+3]=avlon_f;end else local avlon_e;local avlon_i;local avlon_j;avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_h[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_j=avlon_a[3];avlon_i=avlon_c[avlon_j]for avlon_a=avlon_j+1,avlon_a[4]do avlon_i=avlon_i..avlon_c[avlon_a];end;avlon_c[avlon_a[2]]=avlon_i;avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]][avlon_a[3]]=avlon_c[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=(avlon_a[3]~=0);avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_h[avlon_a[3]]=avlon_c[avlon_a[2]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=(avlon_a[3]~=0);avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_h[avlon_a[3]]=avlon_c[avlon_a[2]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_h[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_h[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]={};avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_f[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2]avlon_c[avlon_e]=avlon_c[avlon_e](avlon_g(avlon_c,avlon_e+1,avlon_a[3]))avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]][avlon_a[3]]=avlon_c[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_h[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2]avlon_c[avlon_e](avlon_g(avlon_c,avlon_e+1,avlon_a[3]))avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_h[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_h[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]={};avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]][avlon_a[3]]=avlon_a[4];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_h[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2]avlon_c[avlon_e](avlon_g(avlon_c,avlon_e+1,avlon_a[3]))avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_f[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_h[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_h[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2]avlon_c[avlon_e](avlon_g(avlon_c,avlon_e+1,avlon_a[3]))end;elseif avlon_e<=283 then if avlon_e<=280 then if avlon_e<=278 then local avlon_h;local avlon_j;local avlon_i;local avlon_e;avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2];avlon_i=avlon_c[avlon_a[3]];avlon_c[avlon_e+1]=avlon_i;avlon_c[avlon_e]=avlon_i[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_f[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2]avlon_c[avlon_e]=avlon_c[avlon_e](avlon_g(avlon_c,avlon_e+1,avlon_a[3]))avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]]*avlon_c[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2]avlon_j={avlon_c[avlon_e](avlon_g(avlon_c,avlon_e+1,avlon_a[3]))};avlon_h=0;for avlon_a=avlon_e,avlon_a[4]do avlon_h=avlon_h+1;avlon_c[avlon_a]=avlon_j[avlon_h];end avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];if not avlon_c[avlon_a[2]]then avlon_b=avlon_b+1;else avlon_b=avlon_a[3];end;elseif avlon_e==279 then avlon_c[avlon_a[2]]=avlon_h[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]][avlon_a[3]]=avlon_c[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_h[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_h[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]][avlon_a[3]]=avlon_c[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_h[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_h[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];else local avlon_e;avlon_c[avlon_a[2]][avlon_a[3]]=avlon_c[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]][avlon_a[3]]=avlon_a[4];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]][avlon_a[3]]=avlon_c[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_f[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2]avlon_c[avlon_e]=avlon_c[avlon_e](avlon_g(avlon_c,avlon_e+1,avlon_a[3]))avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]][avlon_a[3]]=avlon_c[avlon_a[4]];end;elseif avlon_e<=281 then local avlon_e;avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2]avlon_c[avlon_e]=avlon_c[avlon_e](avlon_g(avlon_c,avlon_e+1,avlon_a[3]))avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]][avlon_a[3]]=avlon_c[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]][avlon_a[3]]=avlon_a[4];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]][avlon_a[3]]=avlon_c[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_f[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];elseif avlon_e>282 then avlon_c[avlon_a[2]]=(avlon_a[3]~=0);avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_h[avlon_a[3]]=avlon_c[avlon_a[2]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_h[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];if avlon_c[avlon_a[2]]then avlon_b=avlon_b+1;else avlon_b=avlon_a[3];end;else local avlon_i;local avlon_e;avlon_c[avlon_a[2]]=avlon_h[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2];avlon_i=avlon_c[avlon_a[3]];avlon_c[avlon_e+1]=avlon_i;avlon_c[avlon_e]=avlon_i[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2]avlon_c[avlon_e]=avlon_c[avlon_e](avlon_g(avlon_c,avlon_e+1,avlon_a[3]))avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2];avlon_i=avlon_c[avlon_a[3]];avlon_c[avlon_e+1]=avlon_i;avlon_c[avlon_e]=avlon_i[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2]avlon_c[avlon_e]=avlon_c[avlon_e](avlon_c[avlon_e+1])avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_h[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]][avlon_a[3]]=avlon_c[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2];avlon_i=avlon_c[avlon_a[3]];avlon_c[avlon_e+1]=avlon_i;avlon_c[avlon_e]=avlon_i[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2]avlon_c[avlon_e]=avlon_c[avlon_e](avlon_g(avlon_c,avlon_e+1,avlon_a[3]))avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]][avlon_a[3]]=avlon_c[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_f[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2]avlon_c[avlon_e]=avlon_c[avlon_e](avlon_g(avlon_c,avlon_e+1,avlon_a[3]))avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]][avlon_a[3]]=avlon_c[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_h[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]]*avlon_a[4];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]]+avlon_c[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]][avlon_a[3]]=avlon_c[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2];avlon_i=avlon_c[avlon_a[3]];avlon_c[avlon_e+1]=avlon_i;avlon_c[avlon_e]=avlon_i[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2]avlon_c[avlon_e]=avlon_c[avlon_e](avlon_g(avlon_c,avlon_e+1,avlon_a[3]))avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2];avlon_i=avlon_c[avlon_a[3]];avlon_c[avlon_e+1]=avlon_i;avlon_c[avlon_e]=avlon_i[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2]avlon_c[avlon_e]=avlon_c[avlon_e](avlon_g(avlon_c,avlon_e+1,avlon_a[3]))avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2];avlon_i=avlon_c[avlon_a[3]];avlon_c[avlon_e+1]=avlon_i;avlon_c[avlon_e]=avlon_i[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2]avlon_c[avlon_e]=avlon_c[avlon_e](avlon_g(avlon_c,avlon_e+1,avlon_a[3]))avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2];avlon_i=avlon_c[avlon_a[3]];avlon_c[avlon_e+1]=avlon_i;avlon_c[avlon_e]=avlon_i[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2]avlon_c[avlon_e]=avlon_c[avlon_e](avlon_g(avlon_c,avlon_e+1,avlon_a[3]))avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2];avlon_i=avlon_c[avlon_a[3]];avlon_c[avlon_e+1]=avlon_i;avlon_c[avlon_e]=avlon_i[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2]avlon_c[avlon_e]=avlon_c[avlon_e](avlon_g(avlon_c,avlon_e+1,avlon_a[3]))avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2];avlon_i=avlon_c[avlon_a[3]];avlon_c[avlon_e+1]=avlon_i;avlon_c[avlon_e]=avlon_i[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2]avlon_c[avlon_e]=avlon_c[avlon_e](avlon_g(avlon_c,avlon_e+1,avlon_a[3]))avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2];avlon_i=avlon_c[avlon_a[3]];avlon_c[avlon_e+1]=avlon_i;avlon_c[avlon_e]=avlon_i[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2]avlon_c[avlon_e]=avlon_c[avlon_e](avlon_g(avlon_c,avlon_e+1,avlon_a[3]))avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_f[avlon_a[3]];end;elseif avlon_e<=286 then if avlon_e<=284 then local avlon_b=avlon_a[2]avlon_c[avlon_b](avlon_g(avlon_c,avlon_b+1,avlon_a[3]))elseif avlon_e==285 then local avlon_e;avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2]avlon_c[avlon_e]=avlon_c[avlon_e](avlon_g(avlon_c,avlon_e+1,avlon_a[3]))avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]][avlon_a[3]]=avlon_c[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]][avlon_a[3]]=avlon_a[4];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]][avlon_a[3]]=avlon_a[4];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_f[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]][avlon_a[3]]=avlon_c[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]][avlon_a[3]]=avlon_a[4];else local avlon_e;avlon_c[avlon_a[2]][avlon_a[3]]=avlon_a[4];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_f[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2]avlon_c[avlon_e]=avlon_c[avlon_e](avlon_g(avlon_c,avlon_e+1,avlon_a[3]))avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]][avlon_a[3]]=avlon_c[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]][avlon_a[3]]=avlon_a[4];end;elseif avlon_e<=288 then if avlon_e>287 then local avlon_b=avlon_a[2];local avlon_d=avlon_c[avlon_a[3]];avlon_c[avlon_b+1]=avlon_d;avlon_c[avlon_b]=avlon_d[avlon_a[4]];else local avlon_e;local avlon_h;local avlon_k,avlon_m;local avlon_l;local avlon_e;avlon_c[avlon_a[2]]=avlon_f[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_f[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]][avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2];avlon_l=avlon_c[avlon_a[3]];avlon_c[avlon_e+1]=avlon_l;avlon_c[avlon_e]=avlon_l[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2]avlon_k,avlon_m=avlon_j(avlon_c[avlon_e](avlon_c[avlon_e+1]))avlon_i=avlon_m+avlon_e-1 avlon_h=0;for avlon_a=avlon_e,avlon_i do avlon_h=avlon_h+1;avlon_c[avlon_a]=avlon_k[avlon_h];end;avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2]avlon_k={avlon_c[avlon_e](avlon_g(avlon_c,avlon_e+1,avlon_i))};avlon_h=0;for avlon_a=avlon_e,avlon_a[4]do avlon_h=avlon_h+1;avlon_c[avlon_a]=avlon_k[avlon_h];end avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_b=avlon_a[3];end;elseif avlon_e>289 then local avlon_b=avlon_a[2];local avlon_d=avlon_c[avlon_a[3]];avlon_c[avlon_b+1]=avlon_d;avlon_c[avlon_b]=avlon_d[avlon_c[avlon_a[4]]];else avlon_c[avlon_a[2]]();end;elseif avlon_e<=339 then if avlon_e<=314 then if avlon_e<=302 then if avlon_e<=296 then if avlon_e<=293 then if avlon_e<=291 then local avlon_a=avlon_a[2]avlon_c[avlon_a]=avlon_c[avlon_a]()elseif avlon_e==292 then local avlon_d=avlon_a[2]local avlon_e={avlon_c[avlon_d](avlon_g(avlon_c,avlon_d+1,avlon_a[3]))};local avlon_b=0;for avlon_a=avlon_d,avlon_a[4]do avlon_b=avlon_b+1;avlon_c[avlon_a]=avlon_e[avlon_b];end else avlon_c[avlon_a[2]]=avlon_c[avlon_a[3]]-avlon_c[avlon_a[4]];end;elseif avlon_e<=294 then local avlon_j;local avlon_k;local avlon_i;local avlon_e;avlon_c[avlon_a[2]]=avlon_h[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2];avlon_i=avlon_c[avlon_a[3]];avlon_c[avlon_e+1]=avlon_i;avlon_c[avlon_e]=avlon_i[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_a[3];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2]avlon_c[avlon_e]=avlon_c[avlon_e](avlon_g(avlon_c,avlon_e+1,avlon_a[3]))avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2];avlon_i=avlon_c[avlon_a[3]];avlon_c[avlon_e+1]=avlon_i;avlon_c[avlon_e]=avlon_i[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2]avlon_c[avlon_e]=avlon_c[avlon_e](avlon_c[avlon_e+1])avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_h[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]][avlon_a[3]]=avlon_c[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]={};avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_f[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_c[avlon_a[2]]=avlon_h[avlon_a[3]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2];avlon_i=avlon_c[avlon_a[3]];avlon_c[avlon_e+1]=avlon_i;avlon_c[avlon_e]=avlon_i[avlon_a[4]];avlon_b=avlon_b+1;avlon_a=avlon_d[avlon_b];avlon_e=avlon_a[2]avlon_k={avlon_c[avlon_e](avlon_c[avlon_e+1])};avlon_j=0;for avlon_a=avlon_e,avlon_a[4]do avlon_j=avlon_j+1;avlon_c[avlon_a]=avlon_k[avlon_j];end avlon_b=avlon_b+1;av
